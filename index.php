...
function getHomePage(){
	global $curl;
	$novels = array("i-alone-level-up", "legend-of-ling-tian", "monster-pet-evolution", "white-robed-chief", "the-human-emperor", "king-of-gods", "the-legend-of-futian", "reincarnation-of-the-strongest-sword-god", "library-of-heavens-path", "mmorpg-martial-gamer");
	$str = "";
